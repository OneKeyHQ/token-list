...
// Allow '|' in name.
schema.definitions.TokenInfo.properties.symbol = {"type": "string", "minLength": 1}  
...
schema.definitions.TokenInfo.properties.chainId = {"type": "string", "minLength": 1}  // CHANGE TYPE BECAUSE OF COSMOS
